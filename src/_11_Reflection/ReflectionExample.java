...
public class ReflectionExample implements Serializable {
    ...
    private ReflectionExample(String name, String webAddress, String email) {
        this.setName(name);
    ...
    protected ReflectionExample(String name, String webAddress, String email, int zip) {
        this.setName(name);
        this.setWebAddress(webAddress);
        this.setEmail(email);
        this.setZip(2300);
